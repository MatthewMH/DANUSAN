...
| Fitur                  | Fungsi                                                                                         |
| ---------------------- | ---------------------------------------------------------------------------------------------- |
| Fitur Pembelian  Makanan | User dapat memilih toko kemudian diarahkan ke halaman toko yang diinginkan.<br>user juga dapat memilih item danusan pada halaman toko dan menentukan jumlah item<br>danusan yang ingin dibeli  untuk kemudian ditampilkan total harga pembelian|                             
