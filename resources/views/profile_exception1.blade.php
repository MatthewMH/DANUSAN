...
<head>
	...
	<link href="{{ URL::asset('css/profile_exceptionscss/exception1.css') }}" rel="stylesheet" />
	...
	<div class="v0_3">
		...
		<form action = "{{ url('/editprofile/'.Auth()->user()->id) }}">
			...
			<span class="v409_90">Edit Gagal!</span>
				<div class="v409_91">
					<span class = "tulisan">Harap upload gambar dengan ekstensi PNG, JPG, atau JPEG.</span>
				</div>
			</div>
